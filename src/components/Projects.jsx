...
const projects = [
  {
    id: 1,
    title: 'LuxeStore',
    subtitle: 'E-commerce de moda premium',
    category: 'Web,Software',
    desc: 'Tienda online de lujo con experiencia de compra cinematográfica, integración de pagos y sistema de inventario en tiempo real.',
  ...
  },
  {
    ...
    category: 'Web,Software',
    desc: 'ERP personalizado con módulos de RRHH, finanzas y operaciones. Dashboard con métricas en tiempo real y analítica avanzada.',
  ...
  },
  {
    id: 3,
    title: 'AuraStudio',
    subtitle: 'Portfolio arquitectura premium',
    category: 'Web,Software',
    desc: 'Sitio web de alto impacto para estudio de arquitectura con galería 3D, animaciones cinematográficas y formulario de proyectos.',
  ...
  return (
    ...
    >
      ...
      <div className={`relative h-52 bg-gradient-to-br ${project.gradient} flex items-center justify-center overflow-hidden`}>
        {/* Grid on card */}
        <div className="absolute inset-0 tech-grid-bg opacity-30" style={{ backgroundSize: '32px 32px' }} />

        {/* Center icon */}
        <motion.div
          className="relative z-10 w-16 h-16 rounded-2xl flex items-center justify-center border border-white/10"
